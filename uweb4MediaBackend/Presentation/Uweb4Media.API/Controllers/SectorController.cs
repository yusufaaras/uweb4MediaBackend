...
namespace Uweb4Media.API.Controllers
{
    ...
    public class SectorController : ControllerBase
    {
        ...
        public SectorController(
            GetSectorQueryHandler getSectorQueryHandler,
            GetSectorByIdQueryHandler getSectorByIdQueryHandler,
            CreateSectorCommandHandler createSectorCommandHandler,
            UpdateSectorCommandHandler updateSectorCommandHandler,
            RemoveSectorCommandHandler removeSectorCommandHandler)
        {

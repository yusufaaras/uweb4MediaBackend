...
namespace Uweb4Media.API.Controllers
{
    ...
    public class ChannelController : ControllerBase
    {
            ...
            public ChannelController(GetChannelQueryHandler getChannelQueryHandler, GetChannelByIdQueryHandler getChannelByIdQueryHandler, CreateChannelCommandHandler createChannelCommandHandler, UpdateChannelCommandHandler updateChannelCommandHandler, RemoveChannelCommandHandler removeChannelCommandHandler)
            {

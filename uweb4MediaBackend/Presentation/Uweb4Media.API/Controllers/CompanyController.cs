...
namespace Uweb4Media.API.Controllers
{
    ...
    public class CompanyController : ControllerBase
    {
            ...
            public CompanyController(GetCompanyQueryHandler getCompanyQueryHandler, GetCompanyByIdQueryHandler getCompanyByIdQueryHandler, CreateCompanyCommandHandler createCompanyCommandHandler, UpdateCompanyCommandHandler updateCompanyCommandHandler, RemoveCompanyCommandHandler removeCompanyCommandHandler)
            {
